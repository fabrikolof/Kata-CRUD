const getFetchAll = async (table, form, title, template, fragment) => {
        const $table = table,
        $form = form, 
        $title = title,
        $template = template,
...
const deleteFetch = async (id) => {
  ...
  const _getFetchAll = getFetchAll;
export { _getFetchAll as getFetchAll };

  const _postFetch = postFetch;
export { _postFetch as postFetch };

    const _putFetch = putFetch;
export { _putFetch as putFetch };

    const _deleteFetch = deleteFetch;
export { _deleteFetch as deleteFetch };
